<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        {{-- Kami Menerima --}}
        <div class="space-y-4">
            <h3 class="text-lg font-bold text-gray-800 border-b pb-2">KAMI MENERIMA</h3>
            <a href="#" class="flex items-center">
                <img src="{{ asset('img/footer/footerbank.png') }}" alt="Footer Bank">
            </a>
        </div>

        {{-- Temukan Kami --}}
        <div class="space-y-4">
            <h3 class="text-lg font-bold text-gray-800 border-b pb-2">TEMUKAN KAMI</h3>
            <div class="flex space-x-4">
                <!-- Instagram -->
                <a onclick="openModal('instagramModal')"
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-4">
                <h3 class="text-lg font-bold text-gray-800 border-b pb-2">JASA PENGIRIMAN</h3>
                <a href="#" class="flex items-center">
                    <img src="{{ asset('img/footer/KURIR-SYIHAB.png') }}" alt="Kurir Syihab" class="w-64 h-full">
                </a>
            </div>
        </div>
    </div>
    ...
    <div id="instagramModal"
        ...
        <div class="bg-white rounded-lg max-w-md w-full mx-2">
            <div class="flex justify-between items-center border-b p-4">
                <h3 class="text-lg font-bold text-gray-800">Instagram Kami</h3>
                <button onclick="closeModal('instagramModal')" class="text-gray-500 hover:text-gray-700 text-2xl">
                    &times;
                </button>
            </div>
            <div class="p-4">
                ...
                <div class="space-y-3">
                    ...
                    <a href="https://www.instagram.com/syihabpremium/" target="_blank"
                        class="block p-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition duration-200">
                        <div class="flex items-center">
                            <div class="bg-gradient-to-r from-blue-400 to-purple-500 p-2 rounded-full mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" viewBox="0 0 24 24"
                                    fill="currentColor">
                                    <path
                                        d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
                            ...
                            <div>
                                <p class="font-medium">@syihabpremium</p>
                                <p class="text-sm text-gray-500">Syihab Premium Banjarbaru</p>
                            </div>
                        </div>
                    </a>
                    <a href="https://www.instagram.com/syihab__martapura/" target="_blank"
                        class="block p-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition duration-200">
                        <div class="flex items-center">
                            <div class="bg-gradient-to-r from-blue-400 to-purple-500 p-2 rounded-full mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" viewBox="0 0 24 24"
                            ...
                            <div>
                                <p class="font-medium">@syihab__martapura</p>
                                <p class="text-sm text-gray-500">Syihab Martapura</p>
                            </div>
                        </div>
                    </a>
                    <a href="https://www.instagram.com/syihab_veteran/" target="_blank"
                        class="block p-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition duration-200">
                        <div class="flex items-center">
                            <div class="bg-gradient-to-r from-blue-400 to-purple-500 p-2 rounded-full mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" viewBox="0 0 24 24"
                            ...
                            <div>
                                <p class="font-medium">@syihab_veteran</p>
                                <p class="text-sm text-gray-500">Syihab Veteran Banjarmasin</p>
                            </div>
                        </div>
                    </a>
                    <a href="https://www.instagram.com/syihab_sultanadam/" target="_blank"
                        class="block p-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition duration-200">
                        <div class="flex items-center">
                            <div class="bg-gradient-to-r from-blue-400 to-purple-500 p-2 rounded-full mr-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-white" viewBox="0 0 24 24"
                            ...
                            <div>
                                <p class="font-medium">@syihab_sultanadam</p>
                                <p class="text-sm text-gray-500">Syihab Sultan Adama Banjarmasin</p>
                            </div>
                        </div>
                    </a>
                </div>
...
@push('scripts')
    <script>
        ...
        window.onclick = function(event) {
            if (event.target === document.getElementById('instagramModal')) {
