        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            @forelse ($products as $product)
                <div
                    ...
                    @if (!empty($product->variations))
                        <a href="https://wa.me/6282325732742?text={{ urlencode('Halo admin, saya ingin memesan ' . $product->name) }}"
                    ...
                    @else
                        <a href="https://wa.me/6282325732742?text={{ urlencode('Halo admin, saya ingin Pre-Order ' . $product->name) }}"
                            target="_blank" data-product-name="{{ $product->name }}"
